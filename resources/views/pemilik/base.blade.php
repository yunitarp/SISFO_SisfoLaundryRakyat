<?php
  if(Session::has('role') and Session::get('role') != 'pemilik'){
    header('Location:'.url(Session::get('role')));die();
  }else if(!Session::has('role')){
    header('Location:'.url('pemilik/login'));die();
  }
?>
<!DOCTYPE html>
<html>
                        ...
                        <li class="dropdown user user-menu">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="user-header bg-light-blue">
                                    ...
                                    <p>
                                        {{Session::get('username')->nama_depan}}-Pemilik
                                    </p>
                                </li>
                                <!-- Menu Body -->
                                <li class="user-body">
                                ...
                                <li class="user-footer">
                                    ...
                                    <div class="pull-right">
                                        <a href="{{url('/pemilik/logoutpemilik')}}" class="btn btn-default btn-flat">Sign out</a>
                                    </div>
                                </li>
                            </ul>
                        </li>
                    ...
                    <ul class="sidebar-menu">
                        <li class="active treeview">
                            ...
                            <ul class="treeview-menu">
                                <li><a href="{{url('pemilik/persediaanharian')}}"><i class="fa fa-angle-double-right"></i> Persediaan Harian</a></li>
                                <li><a href="{{url('pemilik/persediaanbulanan')}}"><i class="fa fa-angle-double-right"></i> Persediaan Bulanan</a></li>
                                <li><a href="{{url('pemilik/persediaantahunan')}}"><i class="fa fa-angle-double-right"></i> Persediaan Tahunan</a></li>
                            </ul>
                        </li>
                        <li class="treeview">
                            <a href="#">
                            ...
                            <ul class="treeview-menu">
                                <li><a href="{{url('pemilik/pemakaianharian')}}"><i class="fa fa-angle-double-right"></i> Pemakaian Harian</a></li>
                                <li><a href="{{url('pemilik/pemakaianbulanan')}}"><i class="fa fa-angle-double-right"></i> Pemakaian Bulanan</a></li>
                                <li><a href="{{url('pemilik/pemakaiantahunan')}}"><i class="fa fa-angle-double-right"></i> Pemakaian Tahunan</a></li>
                            </ul>
                        </li>
                        <li class="treeview">
                            <a href="#">
                            ...
                            <ul class="treeview-menu">
                                <li><a href="{{url('pemilik/pendapatanharian')}}"><i class="fa fa-angle-double-right"></i> Pemasukkan Harian</a></li>
                                <li><a href="{{url('pemilik/pendapatanbulanan')}}"><i class="fa fa-angle-double-right"></i> Pemasukkan Bulanan</a></li>
                                <li><a href="{{url('pemilik/pendapatantahunan')}}"><i class="fa fa-angle-double-right"></i> Pemasukkan Tahunan</a></li>
                            </ul>
                        </li>
                        <li class="treeview">
                            <a href="#">
                                <i class="fa fa-book"></i>
                                <span>Laporan Untung/Rugi</span>
                            </a>
                            <ul class="treeview-menu">
                                <li><a href="{{url('pemilik/untungrugibulanan')}}"><i class="fa fa-angle-double-right"></i> Untung/Rugi Bulanan</a></li>
                                <li><a href="{{url('pemilik/untungrugitahunan')}}"><i class="fa fa-angle-double-right"></i> Untung/Rugi Tahunan</a></li>
                            </ul>
                        </li>
                </section>
                <!-- /.sidebar -->
