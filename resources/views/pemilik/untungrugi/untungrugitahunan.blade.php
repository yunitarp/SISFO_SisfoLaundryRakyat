@extends('pemilik.base')
                    ...
                    <table id="example1" class="table table-bordered table-striped">
                        ...
                        <tbody>
                            <tr>     
                                ...
                                <td>
                                    <a href="{{url('/pemilik/detailuntungrugitahunan').'/'.$tgl}}"><button type="button" class="btn btn-info">Lihat Detail</button></a>
                                </td>
                            </tr>
                        </tbody>
                        <tfoot>
    ...
    @section('js')
        ...
        var isiTanggal = function(obj){
           document.location.href = "{{url('pemilik/untungrugitahunan')}}/"+obj.val()
        }
