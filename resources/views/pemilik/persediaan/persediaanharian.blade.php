@extends('pemilik.base')
        ...
        <div class="col-xs-12">
        	<div class="box">
                <div class="box-header">
                    <h3 class="box-title">Laporan Persediaan Harian</h3>                                    
                </div><!-- /.box-header -->
                    ...
                    <table id="example1" class="table table-bordered table-striped">
                        ...
                        <?php $totalharga = 0; ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{url('/pemilik/detailpersediaanharian').'/'.$isi['tanggal'].'/'.$isi['stock']->id}}"><button type="button" class="btn btn-info">Lihat Detail</button></a>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
	...
	@section('js')
        ...
        var isiTanggal = function(obj){
           document.location.href = "{{url('pemilik/persediaanharian')}}/"+obj.val()
        }
