    ...
    <section class="content">
        ...
        <div class="box box-primary">
            <div class="box-header">
            	...
            	<!-- form start -->
		        <form class="form-horizontal" action="{{url('/karyawan/inputorderbarukaryawan')}}" method="POST">
		            <div class="box-body">
		                <div class="form-group">
		                    <label class="col-sm-2" >Nama Pelanggan</label>
		          			<div class="col-sm-3">
		          			<input type="text" value="{{$plg['nama_depan']}}" class="form-control" disabled="true">
		          			<input type="hidden" name="pelanggan_id" value="{{$plg['id']}}"/>
		          			</div>
		                </div>
		                <div class="form-group">
		                    <label class="col-sm-2" >Berat</label>
		          			<div class="col-xs-3">
		          			<input type="number" class="form-control" name="berat" id="berat" placeholder="">
		          			</div>
		                </div>
		                <div class="form-group">
		                    ...
		                    <div class="col-sm-3">
			          			<select class="form-control" name="jenis_laundry" id="jenis" onchange="isiHarga($(this))">
			          				<option selected="selected">--PILIH JENIS LAUNDRY--</option>
		                ...
		                <div class="form-group">
		                    <label class="col-sm-2" for="exampleInputEmail1">List Baju</label>
		          			<div class="col-sm-3">
		          			<textarea class="form-control"rows="3" name="list_laundry"></textarea>
		          			</div>
		                </div>
		                <div class="form-group">
                            ...
                            <div class="col-sm-3 input-group">
                                ...
                                <input type="text" class="form-control datepicker" name="tanngal_masuk"/>
                            </div><!-- /.input group -->
                        </div><!-- /.form group -->
		                <div class="form-group">
		                    <label class="col-sm-2" for="exampleInputEmail1">Tanggal Selesai</label>
		          			<div class="col-sm-3 input-group">
                                ...
                                <input type="text" class="form-control datepicker" name="tanggal_selesai"/>
                            </div><!-- /.input group -->
		                </div>
		                <div class="form-group">
