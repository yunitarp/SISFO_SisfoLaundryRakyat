	...
	@section('content')
        ...
        <div class="box box-primary">
            <div class="box-header">
                <h3 class="box-title">Form Update Persediaan</h3>
            </div><!-- /.box-header -->
            	<!-- form start -->
		        <form class="form-horizontal" action="{{url('/karyawan/inputpemasukkan')}}" method="post">
		            <div class="box-body">
		                ...
		                <div class="form-group">
		                    <label class="col-sm-2" for="exampleInputEmail1">Jumlah</label>
		          			<div class="col-sm-2">
			          			<input type="number" class="form-control" name="jumlah_pemasukan" placeholder="Jumlah">
		          			</div>
		                </div>
		                <div class="form-group">
